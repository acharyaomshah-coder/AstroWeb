...
"[project]/DEMO-PROJECTS/AstroWeb/src/pages/api/blog.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    if (req.method === "GET") {
        try {
            const { data: posts, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$DEMO$2d$PROJECTS$2f$AstroWeb$2f$src$2f$lib$2f$supabase$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from("blog_posts").select("*").order("published_at", {
                ascending: false
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__37ec7f9f._.js.map